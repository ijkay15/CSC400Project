...
CLOUDSQL_DATABASE = 'home_inspection'
# Set this value to the Cloud SQL connection name, e.g.
#   "project:region:cloudsql-instance".
# You must also update the value in app.yaml.
CLOUDSQL_CONNECTION_NAME = 'csc-400-project:us-central1:home-inspection-instance'
...
LOCAL_SQLALCHEMY_DATABASE_URI = (
    'mysql+pymysql://root:password@127.0.0.1:3306/home_inspection').format(
...
LIVE_SQLALCHEMY_DATABASE_URI = (
    'mysql+pymysql://root:password@localhost/home_inspection'
    '?unix_socket=/cloudsql/csc-400-project:us-central1:home-inspection-instance').format(
        user=CLOUDSQL_USER, password=CLOUDSQL_PASSWORD,
...
GOOGLE_OAUTH2_CLIENT_ID = \
    '103341720469-ifmv4juc4635rbgk7a07n3kdbqkc9e3n.apps.googleusercontent.com'
GOOGLE_OAUTH2_CLIENT_SECRET = '_UwVbFkPIBhPlgR9J_uAmZML'
